...
image_path = os.path.join(artifacts_dir, "media__1781799528285.png")
output_path = r"c:\Users\istha\Videos\Captures\vz RCS\public\manufacturer-logos\bpi.png"
...
print(f"BPI logo successfully cropped, keyed, and saved to {output_path} (size={img.size})")
